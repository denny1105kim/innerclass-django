...
class Command(BaseCommand):
    help = "Sync EOD market data (top 100 by market cap). Intended to run once per day after market close."
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(
                ...
                f"stocks_upserted={res.stocks_upserted} indicators_upserted={res.indicators_upserted}"
            )
        )
